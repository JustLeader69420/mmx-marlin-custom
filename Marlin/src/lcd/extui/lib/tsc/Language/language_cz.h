...
#define _LANGUAGE_CZ_H_
    ...
    #define CZ_HOME                 "Vyhoumovat"
    #define CZ_PRINT                "Tisk"
    #define CZ_EXTRUDE              "Filament"
    #define CZ_FAN                  "Větrák"
    #define CZ_SETTINGS             "Nastavení"
    #define CZ_SCREEN_SETTINGS      "Obrazovka"
    #define CZ_MACHINE_SETTINGS     "Mašina"
    ...
    #define CZ_RGB_SETTINGS         "Barva LEDky"
    ...
    #define CZ_BED                  "Postel"
    #define CZ_STOP                 "Zastavit"
    #define CZ_BACK                 "Zpět"
    #define CZ_PAGE_UP              "Nahoru"
    #define CZ_PAGE_DOWN            "Dolu"
    #define CZ_PAUSE                "Pozastavit"
    #define CZ_RESUME               "Obnovit"
    #define CZ_LOAD                 "Zavést"
    #define CZ_UNLOAD               "Vysunout"
    #define CZ_SLOW_SPEED           "Pomalu"
    #define CZ_NORMAL_SPEED         "Normálně"
    #define CZ_FAST_SPEED           "Rychle"
    #define CZ_FAN_FULL_SPEED       "Plná"
    ...
    #define CZ_SMART_RUNOUT_ON      "Smart ZAP"
    #define CZ_PERCENTAGE           "Procenta"
    #define CZ_BABYSTEP             "Krůčky"
    ...
    #define CZ_READY                "Tiskárna připravena"
    ...
    #define CZ_READ_ONBOARDSD_ERROR "Chyba při čtení Vestavěné SD!"
    #define CZ_FILAMENT_RUNOUT      "Došel filament!"
    #define CZ_PREHEAT              "Předehřát"
    #define CZ_PREHEAT_BOTH         "Obojí"
    ...
    #define CZ_IS_PAUSE             "Nebylo možné extrudovat při tisku, pozastavit tisk?"
    #define CZ_AUTO_SHUT_DOWN       "Auto Power"
    #define CZ_MANUAL_SHUT_DOWN     "Manual"
    #define CZ_UNIFIEDMOVE          "Pohyb"
    #define CZ_UNIFIEDHEAT          "Teplo&Vzduch"
    #define CZ_COOLDOWN             "Zchladit"
    #define CZ_EMERGENCYSTOP        "NOUZ. STOP"
    #define CZ_TOUCH_TO_EXIT        "Dotkněte se kdekoliv pro zavření"
    #define CZ_MAINMENU             "Menu"
    #define CZ_WAIT_TEMP_SHUT_DOWN  "Vyčkejte prosím, než bude teplota hotendu nižší než " STRINGIFY(AUTO_SHUT_DOWN_MAXTEMP) "℃" // Wait for the temperature of hotend to be lower than 50℃
    #define CZ_FORCE_SHUT_DOWN      "Vynutit"
    #define CZ_SHUTTING_DOWN        "Vypínám..."
    #define CZ_PRINTING_COMPLETED   "Tisk dokončen!"
    #define CZ_STATUS_INFO          "Informace"
    #define CZ_ERROR                "Chyba"
    #define CZ_TIPS                 "Poznámka"
    ...
    #define CZ_RESTART_TO_CONTINUE  "Je vyžadován restart"
    #define CZ_RESTART              "Restart"
    #define CZ_REBOOTING            "Tiskárna se nyní restartuje..."
