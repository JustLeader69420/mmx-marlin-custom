...
const char *const cz2_pack[LABEL_NUM]={
  ...
  CZ2_SETTINGS,
  CZ2_SCREEN_SETTINGS,
  CZ2_MACHINE_SETTINGS,
  CZ2_FEATURE_SETTINGS,
  CZ2_SILENT_ON,
  CZ2_SILENT_OFF,
  CZ2_SHUT_DOWN,
  CZ2_RGB_SETTINGS,
  ...
  CZ2_CONFIRM,
  CZ2_TFTSD,
  CZ2_READ_TFTSD_ERROR,
  CZ2_TFTSD_INSERTED,
  CZ2_TFTSD_REMOVED,
  CZ2_U_DISK,
  CZ2_READ_U_DISK_ERROR,
  CZ2_U_DISK_INSERTED,
  CZ2_U_DISK_REMOVED,
  CZ2_ONBOARDSD,
  CZ2_READ_ONBOARDSD_ERROR,
  CZ2_FILAMENT_RUNOUT,
  CZ2_PREHEAT,
  CZ2_PREHEAT_BOTH,
  CZ2_PREHEAT_PLA,
  ...
  CZ2_TOUCH_TO_EXIT,
  CZ2_MAINMENU,
  CZ2_WAIT_TEMP_SHUT_DOWN,
  CZ2_FORCE_SHUT_DOWN,
  CZ2_SHUTTING_DOWN,
  CZ2_PRINTING_COMPLETED,
  CZ2_STATUS_INFO,
  CZ2_ERROR,
  CZ2_TIPS,
  CZ2_EEPROM_SAVE_SUCCESS,
  CZ2_EEPROM_SAVE_FAILED,
  CZ2_ELAPSED_TIME,
  CZ2_SAVE_POPUP,
...
uint8_t *textSelect(uint8_t sel)
{
  ...
  switch(infoSettings.language)
  {
    ...
    case TFT_CZECH2:       return (uint8_t *)cz2_pack[sel];
