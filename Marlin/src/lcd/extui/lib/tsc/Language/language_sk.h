...
#define _LANGUAGE_SK_H_
    ...
    #define SK_PROBE_OFFSET         "Z Odsadenie"
    ...
    #define SK_WAIT_TEMP_SHUT_DOWN  "Treba počkať na teplotu trysky menej ako" STRINGIFY(AUTO_SHUT_DOWN_MAXTEMP) "℃" // Wait for the temperature of hotend to be lower than 50℃
    ...
    #define SK_ERROR                "Chyba"
    #define SK_TIPS                 "Poznámka"
